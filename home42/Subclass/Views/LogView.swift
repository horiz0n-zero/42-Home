...
final class LogView: BasicUIView, HomeWhiteContainerTableViewCellView {
    ...
    override func willMove(toSuperview newSuperview: UIView?) {
        ...
        self.durationLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor,
                                                    constant: HomeLayout.margin).isActive = true
        self.durationLabel.topAnchor.constraint(equalTo: self.topAnchor,
                                                constant: HomeLayout.margin).isActive = true
        self.durationLabel.trailingAnchor.constraint(lessThanOrEqualTo: self.trailingAnchor,
                                                     constant: -HomeLayout.margin).isActive = true
        ...
        self.endIcon.topAnchor.constraint(equalTo: self.durationLabel.bottomAnchor,
                                          constant: HomeLayout.smargin).isActive = true
        self.endIcon.leadingAnchor.constraint(equalTo: self.durationLabel.leadingAnchor, constant: 2.0).isActive = true
        self.addSubview(self.endLabel)
        self.endLabel.leadingAnchor.constraint(equalTo: self.endIcon.trailingAnchor,
                                               constant: HomeLayout.smargin - 2.0).isActive = true
        ...
        self.startIcon.topAnchor.constraint(equalTo: self.endIcon.bottomAnchor,
                                            constant: HomeLayout.dmargin).isActive = true
        self.startIcon.leadingAnchor.constraint(equalTo: self.durationLabel.leadingAnchor).isActive = true
        self.startIcon.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -HomeLayout.margin).isActive = true
        self.addSubview(self.startLabel)
        self.startLabel.leadingAnchor.constraint(equalTo: self.startIcon.trailingAnchor,
                                                 constant: HomeLayout.smargin).isActive = true
        self.startLabel.centerYAnchor.constraint(equalTo: self.startIcon.centerYAnchor).isActive = true
        self.startLabel.trailingAnchor.constraint(equalTo: self.trailingAnchor,
                                                  constant: -HomeLayout.smargin).isActive = true
    }
    
    func update(with location: IntraClusterLocation) {
