...
final class HomeDesign: NSObject {
    ...
    static let actionRed = UIColor.red
    static let actionOrange = UIColor.orange
    static let actionGreen = UIColor.green
    static let actionYellow = UIColor.yellow
    static let actionBlue = UIColor.blue
