...
//  home42
//
//  Created by Antoine Feuerstein on 12/11/2021.
//
    ...
    static func generateReport(apiJSONText: String? = nil, apiJSONError: HomeApi.RequestError? = nil, completion: (() -> ())? = nil) {
        ...
        DynamicAlert(.noneWithPrimary(HomeDesign.redError),
                     contents: [.imageWithPrimary(.settingsCafard, 50.0, HomeDesign.redError),
                                ...
                                .text(~"CAFARDS_GENERATE")],
                     actions: [.normal(~"CANCEL", nil), .highligth(~"GENERATE", {
...
"""
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            DynamicAlert(.fullPrimary(~"WARNING", HomeDesign.redError), contents: [.text(~"CAFARDS_EMAIL_UNAVAILABLE")], actions: [.normal(~"OK", nil)])
        }
    }
