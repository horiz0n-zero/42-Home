...
extension HomeLayout {
    ...
    static let profilBackgroundHeigth: CGFloat = { 153.0 + App.safeAera.top }()
    ...
    static let userProfilCorrectionViewCellHeight: CGFloat = 104.0
    ...
    static let donationCellHeight: CGFloat = 80.0
}
