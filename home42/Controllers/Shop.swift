...
//  home42
//
//  Created by Antoine Feuerstein on 16/10/2021.
//
...
final class ShopViewController: HomeViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    required init() {
        ...
        self.tableView.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: App.safeAeraMain.left).isActive = true
        self.tableView.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: App.safeAeraMain.right).isActive = true
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        DynamicAlert(.none, contents: [.title(product.name), .text(product.productDescription)], actions: [.normal(~"OK", nil)])
    }
    ...
    final private class ProductView: BasicUIView, HomeFramingTableViewCellView {
        ...
        override func willMove(toSuperview newSuperview: UIView?) {
            ...
            self.titleLabel.topAnchor.constraint(equalTo: self.topAnchor, constant: HomeLayout.smargin).isActive = true
            self.addSubview(self.imageView)
            self.imageView.leadingAnchor.constraint(equalTo: self.titleLabel.leadingAnchor).isActive = true
            self.imageView.trailingAnchor.constraint(equalTo: self.titleLabel.trailingAnchor).isActive = true
            ...
            self.imageView.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -HomeLayout.smargin).isActive = true
            ...
            self.walletLabel.topAnchor.constraint(equalTo: self.imageView.topAnchor, constant: HomeLayout.smargin).isActive = true
        }
        
        private weak var product: IntraProduct!
