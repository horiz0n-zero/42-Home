...
final class CoalitionsBlocViewController: HomeViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    required init() {
        self.header = HeaderWithActionsView(title: ~"TITLE_COALITIONS")
    ...
    @MainActor func setup(with campusId: Int, cursusId: Int) async {
        async let blocs: [IntraBlock] = HomeApi.get(.blocs, params: ["filter[campus_id]":campusId, "filter[cursus_id]":cursusId])
    ...
    final private class CoalitionTableViewCell: BasicUITableViewCell {
        ...
        override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
            ...
            self.scoreLabel.font = HomeLayout.fontSemiBoldBigTitle
