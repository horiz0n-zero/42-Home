//
//  EvaluationPointsHistoric.swift
//  home42
//
//  Created by Antoine Feuerstein on 04/07/2021.
//
...
final class EvaluationPointsHistoricViewController: HomeViewController, UserSearchFieldViewDelegate {
    ...
    init(userId: Int, userLogin: String, primary: UIColor) {
        self.header = .init(title: ~"INFO_EVALUATION_POINTS")
        self.userSearchFieldView = UserSearchFieldView(user: .init(id: userId, login: userLogin), primary: primary)
